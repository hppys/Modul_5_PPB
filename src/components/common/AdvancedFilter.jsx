          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="120">&le; 2 jam</option>
              </select>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
              >
                <option value="desc">Descending (Besar &rarr; Kecil)</option>
                <option value="asc">Ascending (Kecil &rarr; Besar)</option>
              </select>
            </div>
          </div>
